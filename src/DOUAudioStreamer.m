...
NSString *const kDOUAudioStreamerErrorDomain = @"com.appwill.audio-streamer.error-domain";
...
{
    return [DOUAudioFileProvider isCachedWithAudioFile:audioFile];
}

+ (NSString *)cachedFileNameForFile:(id<DOUAudioFile>)audioFile
{
    return [DOUAudioFileProvider cachedPathForAudioFileURL:[audioFile audioFileURL]];
}
...
{
    return [_fileProvider cachedFolder];
}
